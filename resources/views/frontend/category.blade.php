...
@section('title', 'Daily Shop | Category')
@section('container')
  <!-- product category -->
  <!-- product category -->
                   ...
                   <ul class="aa-product-catg">
                      ...
                      @if(isset($product[0]))
                        @foreach($product as $productArr)
                         ...
                         <li>
                           <figure>
                             <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img width="250px" height="300px" src="{{asset('ProductImage/'.$productArr->image)}}" alt="{{$productArr->name}}"></a>
